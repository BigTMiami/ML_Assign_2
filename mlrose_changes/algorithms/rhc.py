...
def random_hill_climb(
    ...
    for current_restart in range(restarts + 1):
        ...
        while (attempts < max_attempts) and (iters < max_iters):
            ...
            if problem.prob_type == "discrete" and attempts == 0:
                problem.set_random_next_neighbors()
            ...
            if problem.prob_type == "continuous":
                ...
                next_state = problem.random_next_neighbor()
                if next_state is None:
                    continue_iterating = False
                    print("Customization by AF Menninger")
                    print(f"RAN OUT OF NEIGHBORS ON ATTEMPT {attempts}.")
                    print("max_attempts should be set equal or lower than problem length.")
                    break
            ###################################################
